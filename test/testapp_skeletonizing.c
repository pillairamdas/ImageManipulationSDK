...
int main(int argc, char *argv[])
{
	...
	skeletonize(input_img, output_img, fg);
	if((dump_to_file(output_img->buffer, output_img->size, "OUT_skeltonized.raw")) != 0) {
		goto FREE_MEM;
	}
	LOG(OUTPUT, "Output Filename: OUT_skeltonized.raw\n");
